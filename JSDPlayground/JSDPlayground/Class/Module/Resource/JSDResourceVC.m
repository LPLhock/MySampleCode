...
//  JSDPlayground
//
//  Created by Jersey on 2019/3/15.
//  Copyright © 2019年 Jersey. All rights reserved.
//

#import "JSDResourceVC.h"


@interface JSDResourceVC ()<UITableViewDataSource, UITableViewDelegate>
...
- (void)setupNavBar {
    self.navigationItem.title = @"第三方库";
}
...
- (NSArray *)model {
    ...
    if (!_model) {
        ...
        NSString* filePath = [[NSBundle mainBundle] pathForResource:@"JSDResource" ofType:@"plist"];

...
#import "JSDMultithreadingVC.h"

@interface JSDMultithreadingVC ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation JSDMultithreadingVC
...
- (NSArray *)model {
    ...
    if (!_model) {
        ...
        NSString* filePath = [[NSBundle mainBundle] pathForResource:@"JSDMultithreading" ofType:@"plist"];

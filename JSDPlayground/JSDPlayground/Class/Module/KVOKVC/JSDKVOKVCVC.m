...
#import "JSDKVOKVCVC.h"

@interface JSDKVOKVCVC ()<UITableViewDataSource, UITableViewDelegate>
...
- (void)setupNavBar {
    self.navigationItem.title = @"KVO&KVC";
}
...
- (NSArray *)model {
    ...
    if (!_model) {
        ...
        NSString* filePath = [[NSBundle mainBundle] pathForResource:@"KVOKVC" ofType:@"plist"];

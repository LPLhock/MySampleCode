...
#import "JSDArithmeticVC.h"

@interface JSDArithmeticVC ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation JSDArithmeticVC
...
- (void)setupNavBar {
    self.navigationItem.title = @"算法相关";
}
...
- (NSArray *)model {
    ...
    if (!_model) {
        ...
        NSString* filePath = [[NSBundle mainBundle] pathForResource:@"JSDArithmetic" ofType:@"plist"];

...
static void * key = &key;
@implementation UIControl (YZHClickHandle)
...
- (void)setYzh_acceptEventTime:(NSTimeInterval)yzh_acceptEventTime {
    ...
    objc_setAssociatedObject(self, key, @(yzh_acceptEventTime), OBJC_ASSOCIATION_ASSIGN);
}
...
- (void)setYzh_acceptEventInterval:(NSTimeInterval)yzh_acceptEventInterval {
    ...
    objc_setAssociatedObject(self, key, @(yzh_acceptEventInterval), OBJC_ASSOCIATION_ASSIGN);
}
